...
function PaymentContent() {
  ...
  const orderId = searchParams.get('orderId') || 'ORD_100293';
...
export default function PaymentPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-slate-900 flex items-center justify-center text-white text-xs">Loading Payment Gateway...</div>}>
      <PaymentContent />
    </Suspense>
  );
}
