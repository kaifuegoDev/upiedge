...
export default function TransactionsTab({
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 rounded-lg bg-white hover:bg-slate-50 border border-slate-200 text-xs font-semibold text-slate-700 shadow-xs transition active:scale-95"
          >
      ...
      {/* Filter Bar */}
      <div className="p-4 rounded-lg bg-white border border-slate-200 shadow-xs flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
        {/* Status Tabs */}
        <div className="flex items-center gap-1.5 overflow-x-auto pb-1 md:pb-0">
          {['ALL', 'SUCCESS', 'PENDING', 'FAILED', 'EXPIRED'].map((status) => {
            ...
            return (
              <button
                ...
                className={`px-3 py-1.5 rounded-md text-xs font-bold whitespace-nowrap transition flex items-center gap-1.5 ${
                  isActive
        ...
        <div className="relative min-w-[240px]">
          ...
          <input
            ...
            className="w-full bg-slate-50 border border-slate-200 rounded-md pl-8 pr-3 py-1.5 text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-blue-500 transition"
          />
        </div>
      </div>
